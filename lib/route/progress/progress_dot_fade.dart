...
class ProgressDotFadeRoute extends StatefulWidget {

  ProgressDotFadeRoute();

  @override
  ProgressDotFadeRouteState createState() => new ProgressDotFadeRouteState();
}


class ProgressDotFadeRouteState extends State<ProgressDotFadeRoute> {
