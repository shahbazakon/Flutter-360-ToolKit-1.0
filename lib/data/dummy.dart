...
class Dummy {
  ...
  static const List<Color> md_color_random = [
    Color(0xFFe91e63), Color(0xFF9c27b0), Color(0xFF673ab7), Color(0xFFE53935),
    Color(0xFF5677fc), Color(0xFF689F38), Color(0xFF03a9f4), Color(0xFF00bcd4),
    Color(0xFF009688), Color(0xFF259b24), Color(0xFFff5722), Color(0xFF795548),
    Color(0xFF607d8b), Color(0xFFff9800)
  ];
  ...
  static const List<String> review_image = [
    "photo_male_2.jpg", "photo_female_7.jpg",
    "photo_male_7.jpg", "photo_female_2.jpg"
  ];
  static const List<String> review_name = [
    "Roberts Turner", "Garcia Lewis",
    "Adams Green", "Jessica M"
  ];
  static const List<String> review_brief = [
    "20 reviews", "152 reviews",
    "86 reviews", "55 reviews" ];
  static const List<double> review_rating = [ 4.7, 5, 4, 5 ];
  static const List<String> review_time = [
    "3 days ago", "a week ago", "2 week ago", "2 week ago"
  ];

  // photo info data
  static const List<String> photo_info_name = [
    "Building", "Nature", "Nightlife", "Person", "Moment",
    "Forest", "Face", "Workout", "Landmark", "Food",
    "Holiday", "Travel", "Bike", "Shopping", "Fashion",
    "Beach"
  ];
  ...
  static const List<IconData> photo_info_icon = [
    Icons.business, Icons.local_florist, Icons.local_cafe,
    Icons.person, Icons.event_seat, Icons.grass,
    Icons.face, Icons.fitness_center, Icons.pin_drop,
    Icons.restaurant, Icons.pool, Icons.airport_shuttle,
    Icons.directions_bike, Icons.shopping_basket, Icons.photo_camera,
    Icons.beach_access
  ];

  static const List<String> review_comment = [
    MyStrings.lorem_ipsum, MyStrings.middle_lorem_ipsum,
    MyStrings.long_lorem_ipsum, MyStrings.middle_lorem_ipsum];
